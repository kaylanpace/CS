...
<head>
    ...
    <title>ConstructionPal - Worker Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/Construction/login.jsp">ConstructionPal</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="/Construction/worker-dashboard.jsp"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="/Construction/buildings.jsp">Add Buildings </a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="/Construction/supplies.jsp">Order Supplies</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="/Construction/equipment.jsp">Order Equipment</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    <p style="width: 260px; height: 28px; ">You are logged in as a Worker.</p>
                    ...
                    <button type="button"onclick="document.location.href='/Construction/admin-viewWorkOrders'" class="btn btn-outline btn-primary btn-lg" style="width: 136px; ">Work Orders</button>
                        <button type="button"onclick="document.location.href='employee.jsp'" class="btn btn-outline btn-primary btn-lg" style="width: 138px; ">Employees</button></a>
                        <button type="button"onclick="document.location.href='/Construction/supplies'" class="btn btn-outline btn-primary btn-lg" style="width: 141px; ">  Supplies </button>
                </div>
                <!-- /.row -->
